...
4. [Privilege escalation of "external user" (with maintainer privilege) to internal access through project token - Bounty: 1,020](https://hackerone.com/reports/1193062)
5. [Improper Authentication - any user can login as other user with otp/logout & otp/login - Bounty: USD 25,000](https://hackerone.com/reports/921780)

# Youtube
1. [Bug Bounty Poc](https://www.youtube.com/channel/UCbGzRMPPHYEs6Lr6w69ahSA/videos)
